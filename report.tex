...
\begin{figure}[!h]
  \centering
  \includegraphics[width=6cm]{figures/client-server}
...
Chaque collaborateur est identifié de manière unique grâce à un \emph{replicanumber} donné par le serveur. 
